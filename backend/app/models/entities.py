...
class Project(Base):
    ...
    escalation_chain_json = Column(JSONB, nullable=True)
    compliance_settings_json = Column(JSONB, nullable=True)
    required_document_types_json = Column(JSONB, nullable=True)
    enable_4_eyes_principal = Column(Boolean, default=False, nullable=False)
